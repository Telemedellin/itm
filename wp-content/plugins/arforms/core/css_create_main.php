...
-moz-box-shadow:1px 2px 3px <?php echo $submit_shadow_color; ?>;-webkit-box-shadow:1px 2px 3px <?php echo $submit_shadow_color; ?>;box-shadow:1px 2px 3px <?php echo $submit_shadow_color; ?>;-ms-filter:"progid:DXImageTransform.Microsoft.Shadow(Strength=3, Direction=135, Color='<?php echo $submit_shadow_color; ?>')";filter:progid:DXImageTransform.Microsoft.Shadow(Strength=3, Direction=135, Color='<?php echo $submit_shadow_color; ?>'); margin:<?php echo $submit_margin ?>; <?php echo $submit_weight_font_style;?> padding:0 10px;<?php if($submit_bg_img != ''){/*?> text-indent:-9999px;min-width:150px; <?php */}else{?>text-indent:0px;<?php }?> text-transform: none;max-width:95%;-webkit-appearance: none !important;-moz-appearance: none !important;appearance:none !important;}
