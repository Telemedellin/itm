...
//                    window.send_to_editor(" [ARForms_popup id=" + form_id + " desc='" + caption + "' type='" + link_type + "' height='" + modal_height + "' width='" + modal_width + "' on_inactivity='" + open_inactivity + "' overlay='" + overlay + "' is_close_link='" + show_close_link + "' modal_bgcolor='" + modal_bgcolor + "']");
...
//            } else if (show_link_type == 'x_seconds') {
//
//                jQuery('#is_x_seconds').slideDown();
...
//            if (show_link_type == 'onload' || show_link_type == 'x_seconds' || show_link_type == 'scroll') {
                ...
                <div class="arfmodalfield_right">
                    ...
                    ?>">
                        <select name="link_type" id="link_type" data-width="272px" onchange="javascript:changetopposition(this.value);">
                            ...
                            <!--<option value="x_seconds"><?php _e('After X seconds of inactivity', 'ARForms'); ?></option>-->
...
<!--            <div class="arfmodalfields" id="is_x_seconds" style="display:none;"> 	
                <div class="arfmodalfield_left"><?php _e('Open popup after X seconds of inactivity after page load', 'ARForms'); ?></div>
                <div class="arfmodalfield_right">
                    <input type="text" name="open_inactivity" id="open_inactivity" value="1" class="txtmodal1" style="width:250px;" />
                </div>          
            </div>-->
            ...
            <!--div class="arfmodalfields" id="arfmodalbuttonstyless">
                <div class="arfmodalfield_left" style='vertical-align:middle;'><?php _e('Background Color :', 'ARForms'); ?></div>
                <div class="arfmodalfield_right">
                    <div class="height_setting" style="display:inline;float:left;width:140px;">
                        <div style="display: inline-block;" id="arf_btn_bgcolor" class="arf_coloroption_sub">
                            <div data-fid="arf_modal_bg_color" class="arf_coloroption arfhex"></div>
                            <div class="arf_coloroption_subarrow_bg">
                                <div class="arf_coloroption_subarrow"></div>
                            </div>
                        </div>
                        <input type="hidden" name="arf_modal_bg_color" id="arf_modal_bg_color" class="txtmodal1" />
                    </div>
