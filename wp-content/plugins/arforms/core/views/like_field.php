...
<?php if( is_admin() ){ ?>
    <div class="controls">
        <div class="like_container">
            ...
            <input type="radio" style="left: -999px;position: absolute;" class="arf_hide_opacity arf_like" name="item_meta[<?php echo $field['id'];?>]" id="field_<?php echo $field['field_key'];?>-0" value="1" <?php checked($field['default_value'], 1);?> /><label id="like_<?php echo $field['field_key'];?>-0" class="arf_like_btn <?php if(isset($field['default_value']) && $field['default_value']=='1'){ echo 'active'; }?> field_edit arfhelptip" for="field_<?php echo $field['field_key'];?>-0" title="<?php echo $field['lbllike'];?>" <?php if(isset($field['default_value']) && $field['default_value']=='1'){ echo 'style="background:'.$field['like_bg_color'].';"'; }?> ><img src="<?php echo ARFURL.'/images/'; ?>like-icon.png" /></label>
    		
            <input type="radio" style="left: -999px;position: absolute;" class="arf_hide_opacity arf_like" name="item_meta[<?php echo $field['id'];?>]" id="field_<?php echo $field['field_key'];?>-1" value="0" <?php checked($field['default_value'], 0);?> /><label id="like_<?php echo $field['field_key'];?>-1" class="arf_dislike_btn <?php if(isset($field['default_value']) && $field['default_value']== '0'){ echo 'active'; }?> field_edit arfhelptip" for="field_<?php echo $field['field_key'];?>-1" title="<?php echo $field['lbldislike'];?>" <?php if(isset($field['default_value']) && $field['default_value']== '0'){ echo 'style="background:'.$field['dislike_bg_color'].';"'; }?>  ><img src="<?php echo ARFURL.'/images/'; ?>dislike-icon.png" /></label>
        </div>       
