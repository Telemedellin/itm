                                ...
                                <td style="padding-bottom:10px;">
                                    ...
                                    <div class="sltstandard" style="float:none;  margin-top:5px;">
                                        <select name="frm_re_lang" id="frm_re_lang" style="width:180px;" data-width='230px' data-size='10'>
                                            ...
                                            /*
                                              array('en' => __('English', 'ARForms'), 'nl' => __('Dutch', 'ARForms'), 'fr' => __('French', 'ARForms'), 'de' => __('German', 'ARForms'), 'pt' => __('Portuguese', 'ARForms'), 'ru' => __('Russian', 'ARForms'), 'es' => __('Spanish', 'ARForms'), 'tr' => __('Turkish', 'ARForms'))
                                             */
                                            ?>
...
<!--                                    <input type="button" value="<?php _e('Send test mail', 'ARForms'); ?>" class="arfbulkbtn arfemailaddbtn" id="arf_send_test_mail" style="display:none;">
<label style="font-size:12px; font-style:italic;  width:100%">(TO : <?php echo $arfsettings->reply_to; ?>)</label>
<label id="arf_success_test_mail" style="font-size:12px; display:none; float:right; width:50%; font-family:'open_sanssemibold',Arial,Helvetica,Verdana,sans-serif; color:#4c9738;"><?php _e('Your test mail is successfully sent', 'ARForms'); ?> </label>-->
                                </td>
                            </tr>
