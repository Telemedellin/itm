...
/*
  ...
  Text Domain: ARForms
 */
global $wpdb, $arfform, $arffield, $db_record, $arfrecordmeta, $user_ID, $arfsettings, $arfcreatedentry, $arfform_params, $MdlDb, $arf_modal_form_loaded, $arformcontroller, $arsettingcontroller, $arrecordcontroller, $armainhelper, $arrecordhelper, $arfieldhelper, $maincontroller, $arf_font_awesome_loaded;
...
$wp_upload_dir = wp_upload_dir();
    ...
    $maincss = "<link rel='stylesheet' type='text/css' href='".$fid."' />";
...
if( isset($_COOKIE['load_footer_scripts']) && $_COOKIE['load_footer_scripts'] != '' && $_COOKIE['load_footer_scripts'] ==  base64_encode('load_footer_scripts') ){
	echo "<link rel='stylesheet' type='text/css' href='".ARFURL."/css/arf_front.css' />";
    
    echo "<script type='text/javascript' src='".ARFURL."/js/arf_modal_js.js'></script>";
	
	echo "<script type='text/javascript' src='".ARFURL."/bootstrap/js/moment-with-locales.js'></script>";
	echo "<script type='text/javascript' src='".ARFURL."/bootstrap/js/bootstrap-datetimepicker.js'></script>";
	
	echo "<script type='text/javascript' src='".ARFURL."/bootstrap/js/modernizr.js'></script>";
	echo "<script type='text/javascript' src='".ARFURL."/bootstrap/js/bootstrap-slider.js'></script>";
	echo "<link rel='stylesheet' type='text/css' href='".ARFURL."/bootstrap/css/bootstrap-slider.css' />";
	
	echo "<script type='text/javascript' src='".ARFURL."/bootstrap/js/bootstrap-select.js'></script>";
	echo "<link rel='stylesheet' type='text/css' href='".ARFURL."/bootstrap/css/bootstrap.css' />";
	echo "<link rel='stylesheet' type='text/css' href='".ARFURL."/bootstrap/css/bootstrap-select.css' />";
	
	
	echo "<link rel='stylesheet' type='text/css' href='".ARFURL."/css/arf_filedrag.css' />";
	
	
	echo "<link rel='stylesheet' type='text/css' href='".ARFURL."/css/colpick.css' />";
	echo "<link rel='stylesheet' type='text/css' href='".ARFURL."/css/font-awesome.min.css'' />";
	
	echo "<script type='text/javascript' src='".ARFURL."/bootstrap/js/icheck.min.js'></script>";
	
	echo "<script type='text/javascript' src='".ARFURL."/js/arf_conditional_logic.js'></script>";
	echo "<script type='text/javascript' src='".ARFURL."/bootstrap/js/bootstrap-inputmask.js'></script>";
	
	echo "<script type='text/javascript' src='".ARFURL."/js/colpick.js'></script>";
	echo "<script type='text/javascript' src='".ARFURL."/js/jquery.simple-color-picker.js'></script>";
	echo "<script type='text/javascript' src='".ARFURL."/js/recaptcha_ajax.js'></script>";
	echo "<link rel='stylesheet' type='text/css' href='".ARFURL."/css/recaptcha_style.css' />";
	
	echo "<script type='text/javascript' src='".ARFURL."/js/arforms.js'></script>";
...
<?php /* 	if($type=='sticky' && $position=='left') 
  {
  ?>
...
//			 </style>';
    ...
    /* 02-02-2015 */ else if ($position == 'left') {
...
wp_register_style('form_custom_css-'.$date_picker, $date_picker_css);
if( isset($_COOKIE['load_footer_scripts']) && $_COOKIE['load_footer_scripts'] != '' && $_COOKIE['load_footer_scripts'] ==  base64_encode('load_footer_scripts') ){
	echo "<link rel='stylesheet' type='text/css' href='".$date_picker_css."' />";
}
...
<style type="text/css">
    ...
    <?php } ?>
<?php if ($type == 'button') { ?>
/*        .arform_modal_button_<?php // echo $form->id; ?> {
            background:<?php // echo $bgcolor; ?>;
            color:<?php // echo $txtcolor; ?>;
        } */
