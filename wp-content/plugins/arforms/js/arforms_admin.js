...
jQuery(document).ready(function ($)
{
    ...
    jQuery('#verify-purchase-code').click(function () {
		...
		document.getElementById("resetlicframe").src = "http://arformsplugin.com/wp-content/themes/arforms/reset_license_page.php?pcode="+ license_key;
        ...
        jQuery.ajax({
            ...
            success: function (html)
            {
                ...
                {
					if(html.trim() == "THIS PURCHASED CODE IS ALREADY USED FOR ANOTHER DOMAIN")
					{
...
//change_password_field_dropdown(); // for password dropdown
    ...
    $('.arfcategorytabs a').click(function () {
        ...
        if ($(this).closest('div').find('.tabs-panel').length > 0) {
            $(this).closest('div').children('.tabs-panel').hide();
        }
        else {
            $(this).closest('div.inside').find('.tabs-panel, .hide_with_tabs').hide();
            if ($(this).closest('ul').hasClass('arfformsettingtabs')) {
                if (t == '#html_settings') {
                    if (pro) {
                        $('#taxonomy-linkcategory .arfcategorytabs li').hide();
                        $('#frm_html_tab').show();
                    }
                    $('#frm_html_tags_tab').click();
                }
                else if ($('#frm_html_tags_tab').is(':visible')) {
                    if (pro) {
                        $('#taxonomy-linkcategory .arfcategorytabs li').show();
                        $('#frm_html_tab').hide();
                    }
    ...
    $("input[name='arffths'] option").each(function () {
        ...
        $(this).hover(function () {
            $('#arfshowcalimage').removeClass().addClass($(this).attr('id'));
        }, '');
    ...
    $("input[name='arffths']").change(function () {
        ...
        var css = calender_url + $(this).val() + '_bootstrap-datetimepicker.css';
        ...
        $('input[name="arffthc"]').val($(this).val());
        $('input[name="arffthn"]').val(themeName);
        
        jQuery('#testiframe').contents().find("body").find(".arf_date_main_controls").removeClass("arf_cal_theme_default_theme arf_cal_theme_1 arf_cal_theme_2 arf_cal_theme_3 arf_cal_theme_4 arf_cal_theme_5");
        jQuery('#testiframe').contents().find("body").find(".arf_date_main_controls").removeClass("arf_cal_theme_6 arf_cal_theme_7 arf_cal_theme_8 arf_cal_theme_9 arf_cal_theme_10");
        jQuery('#testiframe').contents().find("body").find(".arf_date_main_controls").removeClass("arf_cal_theme_11 arf_cal_theme_12 arf_cal_theme_13 arf_cal_theme_14 arf_cal_theme_15");
        jQuery('#testiframe').contents().find("body").find(".arf_date_main_controls").removeClass("arf_cal_theme_16 arf_cal_theme_17 arf_cal_theme_18 arf_cal_theme_19 arf_cal_theme_20");
        jQuery('#testiframe').contents().find("body").find(".arf_date_main_controls").removeClass("arf_cal_theme_21 arf_cal_theme_22 arf_cal_theme_23 arf_cal_theme_24");
        jQuery('#testiframe').contents().find("body").find(".arf_date_main_controls").addClass("arf_cal_theme_"+$(this).val());
        
        jQuery('#testiframe').contents().find("body").find(".arf_time_main_controls").removeClass("arf_cal_theme_default_theme arf_cal_theme_1 arf_cal_theme_2 arf_cal_theme_3 arf_cal_theme_4 arf_cal_theme_5");
        jQuery('#testiframe').contents().find("body").find(".arf_time_main_controls").removeClass("arf_cal_theme_6 arf_cal_theme_7 arf_cal_theme_8 arf_cal_theme_9 arf_cal_theme_10");
        jQuery('#testiframe').contents().find("body").find(".arf_time_main_controls").removeClass("arf_cal_theme_11 arf_cal_theme_12 arf_cal_theme_13 arf_cal_theme_14 arf_cal_theme_15");
        jQuery('#testiframe').contents().find("body").find(".arf_time_main_controls").removeClass("arf_cal_theme_16 arf_cal_theme_17 arf_cal_theme_18 arf_cal_theme_19 arf_cal_theme_20");
        jQuery('#testiframe').contents().find("body").find(".arf_time_main_controls").removeClass("arf_cal_theme_21 arf_cal_theme_22 arf_cal_theme_23 arf_cal_theme_24");
        jQuery('#testiframe').contents().find("body").find(".arf_time_main_controls").addClass("arf_cal_theme_"+$(this).val());
    ...
    if ($.isFunction($.on)) {
        ...
        $('#new_fields').on('click', 'li.ui-state-default', function (evt) {
            arfclickvisfunction(evt.target, $(this));
        });
        $('.arfmainformbuilder').on('keyup', 'input[name^="item_meta"], textarea[name^="item_meta"]', function () {
            arfdefaulttriggers($(this))
        });
        $('.arfmainformbuilder').on('change', 'select[name^="item_meta"]', function () {
            arfdefaulttriggers($(this))
        });

    } else {

        $('li.ui-state-default').live('click', function (evt) {
            arfclickvisfunction(evt.target, $(this));
        });
        $('.arfmainformbuilder input[name^="item_meta"], .arfmainformbuilder textarea[name^="item_meta"]').live('keyup', function () {
            arfdefaulttriggers($(this))
        });
        $('.arfmainformbuilder select[name^="item_meta"]').live('change', function () {
            arfdefaulttriggers($(this))
        });
    ...
    jQuery(".arfoptionul").sortable({
        ...
        stop:function(event,ui){
            ...
            jQuery("#"+ current_id).removeClass('arf_opt_temp_selected');
        },
	start: function( event, ui ) {
            var current_id = ui.item.attr('id');
            jQuery("#"+ current_id).addClass('arf_opt_temp_selected'); 	
	},
        update: function () {
    ...
    jQuery(".arf_smiley_images_main").sortable({
        axis: 'y',
        placeholder: 'opt-placeholder',
        cursor: 'move',
        opacity: 0.80,
...
{
    return;
    if (obj.hasClass('widget-action')) {
        return;
    }
    if (obj.parents().hasClass('arf35trigger')) {
        return;
    }
...
function arfmakerequiredfieldfunction(field_id, required, chkflag) {
    ...
    {
        var switch_to = '1';
        var atitle = 'Click to mark as not compulsory field.';
    ...
    {
        var switch_to = '0';
        var atitle = 'Click to mark as compulsory field.';
        var checked = '';
...
function arfplaceseparatevalue(field_id, required) {
   ...
   //jQuery('.field_' + field_id + '_option_key').toggle();
    ...
    if (checked != '') {
        jQuery('#arf_field_' + field_id + '_opts').attr('style', 'width:100%;');
        jQuery('#arf_field_' + field_id + '_opts').find(".frm_option_key").css('display','block');
        jQuery('#arf_field_' + field_id + '_opts').find(".frm_option_key_label").css('display','block');
        jQuery('#arf_field_' + field_id + '_opts').find(".frm_option_val_label").css('width','270px');
    } else {
        jQuery('#arf_field_' + field_id + '_opts').attr('style', 'width:410px;');
        jQuery('#arf_field_' + field_id + '_opts').find(".frm_option_key").css('display','none');
        jQuery('#arf_field_' + field_id + '_opts').find(".frm_option_key_label").css('display','none');
        jQuery('#arf_field_' + field_id + '_opts').find(".frm_option_val_label").css('width','350px');
    }           
...
function arfdefaultshows(n, fval) {
    if (fval) {
        jQuery('#arfcleardefaultvalueonfocus_' + n + ',#arfcleardefaultvalueonfocus_' + n + ' a').css('visibility', 'visible').fadeIn('slow');
    }
    else {
        jQuery('#arfcleardefaultvalueonfocus_' + n + ',#arfcleardefaultvalueonfocus_' + n + ' a').css('visibility', 'visible').fadeOut('slow');
    }
}
...
function arfcleardefaultvalueonfocus(field_id, active, chkflag)
{
    ...
    if (active == '1') {
        var switch_to = '0';
        var new_class = 'arficoninactive';
        var t = 'Do not clear default text on focus.';
        var checked = '';
    }
    else {
        var switch_to = '1';
        var new_class = '';
        var t = 'Clear default text on focus.';
        var checked = 'checked="checked"';
    }
...
function arfdefaultblank(field_id, active, chkflag)
{
    ...
    if (active == '1') {
        var switch_to = '0';
        var new_class = 'arficoninactive';
        var t = 'Pass the validation with default value.';
        var checked = '';
    }
    else {
        var switch_to = '1';
        var new_class = '';
        var t = 'Do not pass the validation with default value.';
        var checked = 'checked="checked"';
    }
...
function getLastidofop_key(field_id,op_key){
    
    var check_dublict = false;
    var lastliid = jQuery("ul#arfoptionul_"+field_id+" li").each(function(){ 
        var liid = jQuery(this).attr("id");
        var reslastliid = liid.split("arfoptionorder_"+field_id+"-"); 
        if(op_key == reslastliid[1]){
            check_dublict = true;
        }
    });
    
    if(check_dublict){
        var new_op_key = (op_key+1);
        op_key = getLastidofop_key(field_id,new_op_key);
        return op_key;
    }else{
       return op_key;
    }	
...
function arfaddnewfieldoption(field_id)
{   
    var op_key = jQuery("ul#arfoptionul_"+field_id+" li").length;
    
    //var last_op_key = (op_key - 1);
    var lastliid = jQuery("ul#arfoptionul_"+field_id+" li").last().attr('id');
    var reslastliid = lastliid.split("arfoptionorder_"+field_id+"-"); 
    var last_op_key = reslastliid[1];
    
    if(op_key == last_op_key){
       op_key = op_key+1; 
    }
    
    var op_key = getLastidofop_key(field_id,op_key);
    
    var lastli =  jQuery("ul#arfoptionul_"+field_id+" li").last().html();
    
    var rep = new RegExp(field_id+'-'+last_op_key, 'g');
    var new_li = lastli.replace(rep, field_id+'-'+op_key);
    
    var rep1 = new RegExp(field_id+','+last_op_key, 'g');
    new_li = new_li.replace(rep1, field_id+','+op_key);
    
    var rep2 = new RegExp('data-op-key="'+last_op_key+'"','g');
    new_li = new_li.replace(rep2, 'data-op-key="'+op_key+'"');
    
    
    var last_hidden_input =  jQuery("#arf_op_hidden_fieldcheck_sub_"+field_id+" input:last");
    var checked ='';
    if(last_hidden_input.attr('checked') == 'checked'){
        checked = 'checked="checked"';
    }
    var hidden_input = '<input type="'+last_hidden_input.attr("type")+'" id="arf_op_fieldcheck_sub_'+field_id+'-'+op_key+'" name="'+last_hidden_input.attr("name")+'" value="'+last_hidden_input.attr("value")+'" '+checked+' >';
    jQuery("#arf_op_hidden_fieldcheck_sub_"+field_id).append(hidden_input);
    
    var html = '';
    html += '<li id="arfoptionorder_'+field_id+'-'+op_key+'" class="arfoptionli">';
    html += new_li;
    html += '</li>';
    jQuery("ul#arfoptionul_"+field_id).append(html);
    ...
    jQuery.post(ajaxurl, data, function (msg) {
        ...
        if (table == 'row') {
            jQuery('#frm-grid-' + field_id + ' tr:last').after(msg);
        }
...
{
    if(jQuery('ul#arfoptionul_'+field_id+' li' ).length >= 2){
        jQuery('ul#arfoptionul_'+field_id).find('li#arfoptionorder_'+field_id+'-'+opt_key).remove();
        jQuery('#arf_op_hidden_fieldcheck_sub_'+field_id).find('input#arf_op_fieldcheck_sub_'+field_id+'-'+opt_key).remove();
    }
    return false;
    ...
    jQuery.ajax({type: "POST", url: ajaxurl,
        ...
        success: function (msg) {
            ...
            if (is_checkbox_radio == 1)
            {
                jQuery('#arflbl_' + field_id + '-' + opt_key).parent('div.arf_check_radio_fields').fadeOut('slow', function () {
                    CheckFieldPos_height();
                });
            }
            arfupdateoptionorder(field_id);
...
function arffieldhover(show, field_id)
{
    ...
    if (show) {
        jQuery(html_id).children('.arfshowfieldhover').css('visibility', 'visible');
    }
    else {
        if (!jQuery(html_id).is('.selected')) {
            jQuery(html_id).children('.arfshowfieldhover').css('visibility', 'hidden');
        }
    }
}
...
function arfclickvisfunction(target, obj) {
    ...
    jQuery('.arfshowfieldhover').css('visibility', 'hidden');
    obj.children('.arfshowfieldhover').css('visibility', 'visible');
    jQuery('.arfshowfieldclick').hide();
    obj.find('.arfshowfieldclick').show();
    ...
    if (jQuery(i).val()) {
        obj.find('.arfdefaultvalicons').show().css('visibility', 'visible');
    }
    else {
        obj.find('.arfdefaultvalicons').hide().css('visibility', 'hidden');
    }
...
function arfaddcodefornewfield(element, variable)
{
    if (typeof (element) == 'object') {
        ...
        if (element.hasClass('arfnoallow')) {
            return;
        }
    } else {
    ...
    if (!element_id) {
        ...
        var rich = jQuery('#wp-' + element_id + '-wrap.wp-editor-wrap').length > 0;
    }
    ...
    if (content_box)
    {
        if (content_box.hasClass('arfnotemailto')) {
        ...
        if (variable == '[default-html]' || variable == '[default-plain]')
        {
            ...
            jQuery.ajax({type: "POST", url: ajaxurl,
                ...
                success: function (msg) {
                    arfaddnewcontentforfield(element_id, msg, start_pos);
                }
            });
        }
        else
    ...
    if (act == 'delete') {
        if (confirm('Are you sure to delete configuration ?')) {
            jQuery.ajax({
                ...
                success: function (html) {
                    jQuery('#aweber_api_tr1').css('display', '');
        ...
        jQuery.ajax({
            ...
            success: function (html) {
                jQuery('#select_aweber').html(html);
                jQuery(".sltstandard select").selectpicker();
                jQuery('#aweber_loader2').css('display', 'none');
                jQuery('#aweber_refresh').delay(3000).fadeOut('slow');
            }
        });
    }
}
...
function change_frm_entries() {
    ...
    jQuery.ajax({
        ...
        url: ajaxurl, 
        beforeSend: function() {
            jQuery('body').append('<div class="arfmodal-backdrop arflodding_backdrop"></div>');
            jQuery('div#arf_loder_entrie_div').show();
        },
        data: "action=updateentries&form=" + form + "&start_date=" + srart_date + "&end_date=" + end_date,
        success: function (msg) {
            jQuery('.arflodding_backdrop').fadeOut(500,function(){
                 jQuery(this).remove();
            });
...
//            });
	    ...
	    jQuery('#form_entries .arfhelptip').tipso({
		position: 'top',
		maxWidth: '400',
		useTitle: true,
		background: '#444444',
...
function apply_bulk_action() {
    ...
    jQuery.ajax({type: "POST",
        ...
        data: "action=arfchangebulkentries&form=" + form + "&start_date=" + srart_date + "&end_date=" + end_date + "&" + str,
        success: function (msg) {
            jQuery('.arflodding_backdrop').fadeOut(500,function(){
                 jQuery(this).remove();
            });
...
function apply_bulk_action_form() {
    ...
    jQuery.ajax({type: "POST", 
        ...
        beforeSend: function(){
            ...
            jQuery('body').append('<div class="arfmodal-backdrop arflodding_backdrop"></div>');
            jQuery('div#arf_loder_form_list_div').show();
        },
        data: "action=arfupdateformbulkoption&" + str,
        success: function (msg) {
            
            jQuery('.arflodding_backdrop').fadeOut(500,function(){
                 jQuery(this).remove();
            });
            jQuery('div#arf_loder_form_list_div').hide();
...
//                maxWidth: 400,
//            });
            jQuery('#armainformnewlist .arfhelptip').tipso({
		position:'top',
		maxWidth:'400',
		useTitle:true,
		background:'#444444',
...
//                maxWidth: 400,
//            });
	    jQuery('#arfmainformnewlist .arfhelptip').tipso({
		position: 'top',
		maxWidth: '400',
		useTitle: true,
		background: '#444444',
...
function arfupdatebulkoptions(field_id, opts) {
    ...
    jQuery.ajax({
        ...
        success: function (res) {
            ...
            if (jQuery('select[name="item_meta[' + field_id + ']"]').length > 0) {
                ...
                for (var i = 0; i < o.length; i++) {
                    ...
                    if(o[i].indexOf("|")>0 )
                    {
                        ...
                        value_data = new_data[1];
                    }
                    sel += '<option value="' + value_data + '">' + label_data + '</option>';
                }
            ...
            setTimeout(function () {
                document.getElementById("arfshowfieldbulkoptions_success-" + field_id).style.display = "none";
            }, 1000);
        }
    });
}
...
function add_new_rule(field_id) {
    ...
    var rules = [];
    jQuery('input[name^="rule_array_' + field_id + '"]').each(function () {
    ...
    field_menu += '<i class="arfa arfa-caret-down arfa-lg"></i></dt>';
    ...
    operator_menu += '<i class="arfa arfa-caret-down arfa-lg"></i></dt>';
...
//        jQuery('#conditional_logic_display_' + field_id).parents('.sltstandard').first().tooltipster({theme: 'arf_admin_tooltip', position: 'top', contentAsHTML: true, onlyOne: true, content: atitle, multiple: true, maxWidth: 400});
	...
	jQuery('#conditional_logic_display_'+field_id).parents('.sltstandard').first().tipso({
	    position:'top',
	    maxWidth:'400',
	    useTitle:false,
	    background:'#444444',
	...
	jQuery('#conditional_logic_if_cond_'+field_id).parents('.sltstandard').first().tipso({
	    position:'top',
	    maxWidth:'400',
	    useTitle:false,
	    background:'#444444',
...
function change_cl_field_menu(field_id) {
    ...
    if (field_opt != '') {
        jQuery('.field_dropdown_menu').not('#arf_cl_field_' + f_id + '_1').each(function (i) {
            if (!jQuery(this).hasClass('field_dropdown_list_menu'))
            {
            ...
            if (jQuery(this).is(':visible')) {
                ...
                if (type != 'divider' && type != 'break' && type != 'captcha' && type != 'html' && type != 'file' && type != 'imagecontrol') {
                    ...
                    if ($globalselect.find('li[data-value="' + f_id + '"]').length > 0)
                    {
                        ...
                        if(!$globalselect.hasClass('field_dropdown_list_menu'))
                        {
                            $globalselect.append(field_opt);
                            //$globalselect.html(field_opt);
                        }
                    }
                }
            }
...
function arf_add_new_law(id) {
    ...
    try {
        jQuery('#conditional_logic_display_' + id).parents('.sltstandard').first().tipso('destroy');
        jQuery('#conditional_logic_display_' + id).parents('.sltstandard').first().removeAttr('title');
        jQuery('#conditional_logic_if_cond_' + id).parents('.sltstandard').first().tipso('destroy');
...
function arf_change_name_dropdown(field_id) {
    ...
    if (jQuery('#' + field_id).is(':visible')) {
        ...
        if (type != 'divider' && type != 'break' && type != 'captcha' && type != 'imagecontrol') {
            conditional_field_opt = '<li class="arf_selectbox_option" data-value="' + f_id + '" data-label="' + name + '">' + name + '</li>';
        }
    }
    ...
    if (conditional_field_opt != '') {
        jQuery('.arf_conditional_field_dropdown').each(function (i) {
            jQuery(this).append(conditional_field_opt);
        });
    }
    ...
    if (typeof arf_change_name_dropdown_call_outside == 'function') {
        arf_change_name_dropdown_call_outside(field_id);
    }
...
function arf_update_name_dropdown() {
        ...
        if (jQuery(this).is(':visible')) {
            ...
            if (type != 'divider' && type != 'break' && type != 'captcha' && type != 'html' && type != 'imagecontrol') {
                ...
                if (type == "checkbox")
                {
                    ...
                    if(jQuery('#arfoptionul_' + id + ' li').length > 0){
                        ...
                        jQuery('#arf_op_hidden_fieldcheck_sub_' + id + ' input').each(function () {
                            var inputid = jQuery(this).attr('id');
                            var label = jQuery(this).attr('data-label');
                            var keyarr = inputid.split('arf_op_fieldcheck_sub_'+id+'-');
                            var key = keyarr[1];
                            if (type == 'checkbox'){
                                fields_list_addtotal += '<div class="modal_field_val" id="arfmodalfieldval_' + id + '_' + key + '" onclick="arfaddtotalfield(this,\'' + id + '\',\'' + key + '\')">&nbsp;&nbsp;&nbsp;&nbsp;' + label.substring(0, 40) + '</div>';
                            }
    ...
    if (typeof arf_update_name_dropdown_call_outside == 'function') {
        arf_update_name_dropdown_call_outside();
    }
...
function arf_delete_name_dropdown(field_id, f_id) {
    ...
    if (typeof arf_delete_name_dropdown_call_outside == 'function') {
        arf_delete_name_dropdown_call_outside(field_id, f_id);
    }
...
function arf_change_field_spacing() {
    var vertical = jQuery('#arffieldinnermarginssetting_1_exs').arf_slider('getValue');
    var horizontal = jQuery('#arffieldinnermarginssetting_2_exs').arf_slider('getValue');
    var final_val = '';
...
function arf_change_slider_class(field_id) {
    ...
    if(jQuery('#arf_range_selector_' + field_id).is(':checked'))
    { 
        jQuery('#slider_sample_' + field_id).removeClass('slider_class slider_class2 slider_class3');
        if (type == 'triangle') {
            jQuery('#slider_sample_' + field_id).removeClass('slider_range_class slider_range_class2').addClass('slider_range_class3');
        } else if (type == 'square') {
            jQuery('#slider_sample_' + field_id).removeClass('slider_range_class2 slider_range_class3').addClass('slider_range_class2');
        } else {
            jQuery('#slider_sample_' + field_id).removeClass('slider_range_class2 slider_range_class3').addClass('slider_range_class');
        }
    }else{
        jQuery('#slider_sample_' + field_id).removeClass('slider_range_class slider_range_class2 slider_range_class3');
        if (type == 'triangle') {
...
function arfgetformpreview()
{
    ...
    mysack.onError = function () {
        alert('Ajax error while saving form');
    };
    ...
    function loaded_ajax_DoShow3() {
        ...
        if (sucmessage == 'deleted') {
            ...
            jQuery('#form_previewmodal').arfmodal({show: true});
        }
    ...
    jQuery('#arfdevicepreview').load(function () {
        ...
        var chk_checkbox_icon_color = jQuery('#checked_checkbox_icon_color').val();
        var chk_radio_icon_color = jQuery('#checked_radio_icon_color').val();
    ...
    for (var i = 0; i < queryArr.length; i++) {
        if (queryArr[i].locations.locID != '' && queryArr[i].locations.locValue != '') {
            ...
            if (queryArr[i].locations.locValue == 'arf_2')
            {
                ...
                {
                    if (column1_id != '') {
                        jQuery('#arfmainfieldid_' + column1_id).height(max_height);
                    }
                    if (jQuery('#arfmainfieldid_' + column1_id).next().hasClass('blankli2col')) {
                        jQuery('#arfmainfieldid_' + column1_id).next().height(max_height);
                    } else if (column2_id != '') {
                        jQuery('#arfmainfieldid_' + column2_id).height(max_height);
                    }
                }
                else if (if_large_height)
                {
                    if (column1_id != '') {
                        jQuery('#arfmainfieldid_' + column1_id).css('height', '120px');
                    }
                    if (jQuery('#arfmainfieldid_' + column1_id).next().hasClass('blankli2col')) {
                        jQuery('#arfmainfieldid_' + column1_id).next().height(max_height);
                    } else if (column2_id != '') {
                ...
                {
                    if (column1_id != '') {
                        jQuery('#arfmainfieldid_' + column1_id).css('height', '75px');
                    }
                    if (jQuery('#arfmainfieldid_' + column1_id).next().hasClass('blankli2col')) {
                        jQuery('#arfmainfieldid_' + column1_id).next().height(max_height);
                    } else if (column2_id != '') {
            ...
            else if (queryArr[i].locations.locValue == 'arf_3')
            {
                ...
                if (if_large_checkbox_radio)
                {
                    ...
                    if (jQuery('#arfmainfieldid_' + column1_id).next().next().hasClass('blankli33col')) {
                        ...
                        jQuery('#arfmainfieldid_' + column3_id).height(max_height);
                    }
                }
                else if (if_large_height)
                {
                    ...
                    if (jQuery('#arfmainfieldid_' + column1_id).next().next().hasClass('blankli33col')) {
                        ...
                        jQuery('#arfmainfieldid_' + column3_id).css('height', '120px');
                    }
                }
                else
                {
                    ...
                    if (jQuery('#arfmainfieldid_' + column1_id).next().next().hasClass('blankli33col')) {
                        ...
                        jQuery('#arfmainfieldid_' + column3_id).css('height', '75px');
                    }
                }
...
function arf_open_field_options(field_id)
{
    ...
    if (!jQuery('#arf_field_op_html_' + field_id).hasClass('arf_has_op_html')) {

        jQuery.ajax({
            type: "POST", url: ajaxurl,
            beforeSend: function () {
                jQuery('#arf_field_op_html_loder_' + field_id).fadeIn('slow');
            },
            data: "action=arf_field_op_lord_html&field_id=" + field_id,
            success: function (res) {

                jQuery('#arf_field_op_html_loder_' + field_id).fadeOut('slow');

                //jQuery('#arf_field_op_html_' + field_id).find("form#arf_op_form_" + field_id).html(res).fadeIn('slow');
                jQuery('#arf_field_op_html_' + field_id).find("form#arf_op_form_" + field_id).html(res).fadeIn('slow');

                jQuery('#arf_field_op_html_' + field_id).addClass('arf_has_op_html');
                ...
                setTimeout(function(){
                    jQuery('#arfoptionul_'+field_id + ' li').each(function(x){
                         var lableheight = jQuery("#field_"+field_id+"-"+x).height();
                         var valheight = jQuery("#field_key_"+field_id+"-"+x).height();
                         
                         if(lableheight > valheight){
                            jQuery("#field_key_"+field_id+"-"+x).css('height',lableheight+'px');
                         }
                         
                         if(lableheight < valheight){
                            jQuery("#field_"+field_id+"-"+x).css('height',valheight+'px');
                         }
...
function arfchangesubcheckradio(field_id)
{
    if (jQuery('#fieldcheck_' + field_id).is(':checked'))
    {
        ...
        jQuery('#arf_op_fieldcheck_sub_' + field_id).attr('checked', true);
        jQuery('#arf_op_fieldcheck_sub_' + field_id).val(jQuery('#fieldcheck_' + field_id).val());
    }
    else
    {
        jQuery('#fieldcheck_sub_' + field_id).attr('checked', false);
        jQuery('#arf_op_fieldcheck_sub_' + field_id).attr('checked', false);
    }
}
...
function arfreordercheckradio(field_id)
{
    ...
    jQuery('#arfoptionul_' + field_id + ' li').each(function () {
        ...
        if (jQuery('#field_' + field_id + '-' + key).hasClass('editInPlace-active'))
        {
            ...
            if (label === undefined) {
                label = jQuery('#field_' + field_id + '-' + key).html();
            }
        } else {
            var label = jQuery('#field_' + field_id + '-' + key).html();
        }
...
function arfresetlikefield(field_id)
{
    ...
    jQuery('#arfmainfieldid_' + field_id).find('.arf_dislike_btn, .arf_like_btn').css('background','');
}
...
function arf_is_smtp_authentication(){
    if (jQuery("input#is_smtp_authentication").is(':checked')) {
        jQuery('.arf_authentication_field').show();
    }else{
        jQuery('.arf_authentication_field').hide();
    }
}
...
function arfvalidateregex(field_id)
{
    ...
    if (typeof (__ARFINVALIDF) != 'undefined') {
        var message = __ARFINVALIDF;
    }
    else {
        var message = 'Your formula is invalid';
    }
    ...
    else
    {
        try {
            ...
            if (typeof (__ARFVALIDF) != 'undefined') {
                var message = __ARFVALIDF;
            }
            else {
                var message = 'Your Formula is valid';
            }
            jQuery('#arf_validate_result_' + field_id).removeClass('arfvalidaterror').addClass('arfvalidatsuccess').show().html(message);
            setTimeout(function () {
                jQuery('#arf_validate_result_' + field_id).hide();
            }, 5000);
        } catch (e) {
            jQuery('#arf_validate_result_' + field_id).removeClass('arfvalidatsuccess').addClass('arfvalidaterror').show().html(message);
        }
...
jQuery(document).on('click', '.arf_fainsideimge', function (e) {
//    if(jQuery(this).hasClass('arf_fainsideimge_check'))
//    {
//        return false;
//    }
    var fid = jQuery(this).attr('data-id');
    ...
    if( field == 'arf_smiley_icon'){
	var fa_class = jQuery(this).attr('id');
	var fa_name = jQuery(this).attr('title');
	jQuery(document).find('.arf_fainsideimge').removeClass('arf_font_awesome_active');
	jQuery(this).addClass('arf_font_awesome_active');
	var font_classes = fa_class.split('_');
	var class_1 = font_classes[0] ? font_classes[0] : '';
	var class_2 = font_classes[1] ? font_classes[1] : '';
	jQuery('#fontselected_1').val(class_1 + ' arfa-lg');
	...
	close_btn.innerHTML = '<i class=\'arfa arfa-close\'></i>';

	var label_1 = document.createElement('label');
	label_1.innerHTML = '28 X 28';
	label_1.setAttribute('class', 'fa_icon_name');

	var label_2 = document.createElement('label');
	label_2.innerHTML = '45 X 45';
	label_2.setAttribute('class', 'fa_icon_name');

	var label_3 = document.createElement('label');
	label_3.innerHTML = '64 X 64';
	label_3.setAttribute('class', 'fa_icon_name');

	var fa_size_1 = document.createElement('i');
	fa_size_1.setAttribute('class', 'arfa arfa-lg ' + fa_class);
	fa_size_1.setAttribute('id', 'fa_size');

	var fa_size_2 = document.createElement('i');
	fa_size_2.setAttribute('class', 'arfa arfa-2x ' + fa_class);
	fa_size_2.setAttribute('id', 'fa_size');

	var fa_size_3 = document.createElement('i');
	fa_size_3.setAttribute('class', 'arfa arfa-3x ' + fa_class);
	...
	if (jQuery(this).hasClass('add_header_font_awesome'))
	    div_1.setAttribute('class', 'fa_size_header normal');
	else
	    div_1.setAttribute('class', 'fa_size normal');

	div_1.setAttribute('id', 'fa_size_normal');
	jQuery(div_1).append(fa_size_1);
	jQuery(div_1).append(label_1);

	var div_2 = document.createElement('div');

	if (jQuery(this).hasClass('add_header_font_awesome'))
	    div_2.setAttribute('class', 'fa_size_header medium');
	else
	    div_2.setAttribute('class', 'fa_size medium');

	div_2.setAttribute('id', 'fa_size_medium');
	jQuery(div_2).append(fa_size_2);
	jQuery(div_2).append(label_2);

	var div_3 = document.createElement('div');

	if (jQuery(this).hasClass('add_header_font_awesome'))
	    div_3.setAttribute('class', 'fa_size_header large');
	else
	    div_3.setAttribute('class', 'fa_size large');

	div_3.setAttribute('id', 'fa_size_large');
	jQuery(div_3).append(fa_size_3);
	jQuery(div_3).append(label_3);
	jQuery(wrapper_div).append(div_1);
	jQuery(wrapper_div).append(div_2);
	...
	if (position.left <= 400)
	    jQuery("#font_awesome_size").removeClass('show_to_right');
	else
	    jQuery("#font_awesome_size").addClass('show_to_right');
	if (position.top <= 280)
	...
	if (html == '') {
		...
		jQuery("#arf_" + field + "_icon").val('');
		jQuery("#arf_select_" + field).html(jQuery(this).attr("no_icon_text"));
		jQuery("#arf_remove_" + field).hide();
		jQuery("#enable_arf_" + field).val(0);
		add_editor_check_radio(field);
	    }
	...
	if (field == 'prefix') {
	    ...
	    jQuery('#arf_checkbox_icon').val(jQuery(this).attr('id'));
	    jQuery('#arf_select_checkbox').html(html);
	    jQuery('#arf_remove_checkbox').show();
	    jQuery('#enable_arf_checkbox').val(1);

	    add_editor_check_radio(field);
	} else if (field == 'radio') {
	    jQuery('#arf_radio_icon').val(jQuery(this).attr('id'));
	    jQuery('#arf_select_radio').html(html);
      ...
      /*20-06-2015  
    } else if (field == 'arf_smiley_icon') {   
        var arr_field_id = fid.split('_');
        jQuery('#field-option-' + arr_field_id[0]).find('#arfimage_url_' + fid).val(jQuery(this).attr('id'));
        jQuery('#field-option-' + arr_field_id[0]).find('#arfsmiley_type_' + fid).val('icon');
    }
    */
...
function add_editor_prefix_suffix(field_id, ftype) {
    ...
    if (ftype != 'time') {
        ...
        if (jQuery('#enable_arf_prefix_' + field_id).val() == 1 && jQuery('#arf_prefix_icon_' + field_id).val() != '') {
            ...
            new_html += "<i class='arfa " + jQuery('#arf_prefix_icon_' + field_id).val() + "'></i>";
            new_html += "</span>";
        }
        ...
        if (jQuery('#enable_arf_suffix_' + field_id).val() == 1 && jQuery('#arf_suffix_icon_' + field_id).val() != '') {
            ...
            new_html += "<i class='arfa " + jQuery("#arf_suffix_icon_" + field_id).val() + "'></i>";
            new_html += "</span>";
        }
    ...
    if (browserName == "Chrome" || browserName == "Safari" || browserName == "Opera")
    {
        if (event.keyCode == 46 || event.keyCode == 8 || event.keyCode == 9 || event.keyCode == 27 || event.keyCode == 13 || event.keyCode == 116 || event.keyCode == 107 || event.keyCode == 109 || event.keyCode == 110 ||
                ...
                // Allow: Ctrl+A
                                                                            ...
                                                                            else
                                                                            {
                                                                                if (event.keyCode == 46 || event.keyCode == 8 || event.keyCode == 9 || event.keyCode == 27 || event.keyCode == 13 || event.keyCode == 116 || event.keyCode == 107 || event.keyCode == 109 || event.keyCode == 110 || event.keyCode == 187 ||
                                                                                        ...
                                                                                        // Allow: Ctrl+A
                                                                                                ...
                                                                                                jQuery(document).on('click', '.arf_date_days_btn', function () {
                                                                                                    var days_val = jQuery(this).closest('.arf_date_days_val_wrapper').find('.arf_date_days_val').val();
                                                                                                    var total_days = new Array();
                                                                                                    if (days_val != "")
                                                                                                    {
                                                                                                        var total_days = days_val.split(',');
                                                                                                    }
                                                                                                    ...
                                                                                                    jQuery(this).closest('.arf_date_days_val_wrapper').find('.arf_date_days_val').val(total_days.sort().toString());
                                                                                                });


                                                                                                /**22-05-2015**/
                                                                                                function open_arf_modal_add_smiley_images(data_insert_id, data_insert, field_id)
                                                                                                {
                                                                                                    jQuery("#arf_media_upload_iframe").remove();

                                                                                                    jQuery('.arf_modal_box').css('top', Number(jQuery('#main_fieldoptions_modal_' + field_id).offset().top) - Number(28) + 'px');
                                                                                                    ...
                                                                                                    window.send_to_editor = function (html) {
                                                                                                        ...
                                                                                                        if (data_insert == 'image')
                                                                                                        {
                                                                                                           ...
                                                                                                           jQuery('#arfimage_url_' + data_insert_id).val(img_src);
                                                                                                           jQuery('#arfsmiley_type_' + data_insert_id).val('image');
                                                                                                        }
                                                                                                        arfmodal_media_upload_close();
                                                                                                    };
                                                                                                }
                                                                                                ...
                                                                                                function arf_add_new_smiley_image(field_id)
                                                                                                {
                                                                                                    if (field_id == '') {
                                                                                                        return false;
                                                                                                    }
                                                                                                    ...
                                                                                                    var metas = [];
                                                                                                    jQuery('input[name^="arf_smiley_images_array"]').each(function () {
                                                                                                    ...
                                                                                                    jQuery.ajax({type: "POST", url: ajaxurl, data: "action=arf_add_new_smiley_image&field_id=" + field_id + "&next_rule_id=" + next_meta_id,
                                                                                                        success: function (msg) {

                                                                                                            jQuery('ul#arf_smiley_images_section_' + field_id).append(msg);

                                                                                                            jQuery('.bulk_add').attr('disabled', false);

                                                                                                            if (jQuery('.arf_smiley_images_main .arf_smiley_images_content').length == 1) {
                                                                                                                jQuery(".bulk_add_remove").find('span.bulk_remove').hide();
                                                                                                            } else {
                                                                                                                jQuery(".bulk_add_remove").find('span.bulk_remove').show();
                                                                                                            }
                                                                                                        }
                                                                                                    });
                                                                                                ...
                                                                                                function arf_delete_smiley_image(field)
                                                                                                {
                                                                                                    if (jQuery('.arf_smiley_images_main .arf_smiley_images_content').length > 2)
                                                                                                    {
                                                                                                        jQuery(field).parents('.arf_smiley_images_content').first().remove();
                                                                                                    }
                                                                                                    else
                                                                                                    {
                                                                                                        jQuery(field).parents('.arf_smiley_images_content').first().remove();
                                                                                                        jQuery('.bulk_add_remove .bulk_remove').hide();
                                                                                                    }
                    ...
                    /*For send testmail */                                                                            
function arf_show_test_mail() {
    
    if (jQuery("input#is_smtp_authentication").is(':checked')) {
        if (jQuery('input#frm_smtp_host').val() != '' && jQuery('input#frm_smtp_port').val() != '' && jQuery('input#frm_smtp_username').val() != '' && jQuery('input#frm_smtp_password').val() != '') {
            jQuery('#arf_send_test_mail').attr('disabled', false);
        } else {
            jQuery('#arf_send_test_mail').attr('disabled', true);
        }
    } else {
        if (jQuery('input#frm_smtp_host').val() != '' && jQuery('input#frm_smtp_port').val() != '') {
            jQuery('#arf_send_test_mail').attr('disabled', false);
        } else {
            jQuery('#arf_send_test_mail').attr('disabled', true);
        }
...
jQuery(document).on('click', '#arf_send_test_mail', function () {
    ...
    if (send_mail) {
        ...
        var send_to = jQuery('input#sendtestmail_to').val();
        var reply_to = jQuery('input#frm_reply_to').val();
        var reply_to_name = jQuery('input#frm_reply_to_name').val();
        var is_smtp_authentication = false;
        if (jQuery("input#is_smtp_authentication").is(':checked')) {
            is_smtp_authentication = true;
        }
        /*var massage = "This is test mail";
        var subject = "Test subject"; */
        
	var message = jQuery("#sendtestmail_msg").val();
	var subject = "SMTP Test E-Mail";

        if (reply_to) {
	    jQuery('#arf_send_test_mail_loader').show();
            jQuery.ajax({
                type: "POST", url: ajaxurl,
                //data: "action=arf_send_test_mail&reply_to=" + reply_to + "&massage=" + massage + "&subject=" + subject,
                data: "action=arf_send_test_mail&send_to=" + send_to +"&reply_to=" + reply_to+"&reply_to_name="+reply_to_name+"&message="+message+"&subject="+subject+"&is_smtp_authentication="+is_smtp_authentication,
                success: function (rec)
                {
                    var rec_obj = jQuery.parseJSON(rec);
                    if (rec_obj.success == "true") {
                        jQuery('#arf_error_test_mail').hide();
                        jQuery('#arf_success_test_mail').show();
                        jQuery('#arf_success_test_mail').delay(3000).fadeOut('slow');
			jQuery('#sendtestmail_to').val('');
			jQuery('#sendtestmail_msg').val('');
                    }else{
                        if(rec_obj.msg != ''){
                            jQuery('#arf_error_test_mail').html(rec_obj.msg);
                            jQuery('#arf_error_test_mail').show();
                        }
                    }
		    jQuery('#arf_send_test_mail_loader').hide();
                }
            });
        }
...
/*20-06-2015*/
jQuery(document).on('click', '.arf_smiley_icon_btn', function (e) {
    var data_id = jQuery(this).attr('data-id');
    var field_id = jQuery(this).attr('field-id');
    var type = jQuery(this).attr('data-field');
    showfontawesomemodal(field_id+"_"+data_id, type);
});


/*jQuery(document).on('click', '.arf_fainsideimge_multi', function () {

    var fa_class = jQuery(this).attr('id');
    var fa_name = jQuery(this).attr('title');
    jQuery(document).find('.arf_fainsideimge_multi').removeClass('arf_font_awesome_active');
    jQuery(this).addClass('arf_font_awesome_active');
    var font_classes = fa_class.split('_');
    var class_1 = font_classes[0] ? font_classes[0] : '';
    var class_2 = font_classes[1] ? font_classes[1] : '';
...
jQuery(document).on('click', '.fa_size', function () {
    setTimeout(function(){
        jQuery("#font_awesome_size").remove();
    },100);
   var fid = jQuery(".arf_font_awesome_active").attr('data-id');
   var field = jQuery(".arf_font_awesome_active").attr('data-field');
   var icon = jQuery(this).find('i').attr('class');
   
   if (field == 'arf_smiley_icon'){   
        var arr_field_id = fid.split('_');
        jQuery('#field-option-' + arr_field_id[0]).find('#arfimage_url_' + fid).val(icon);
        var arfsmiley_type = jQuery('#field-option-' + arr_field_id[0]).find('#arfsmiley_type_' + fid).val();
        
        jQuery('#arfmainfieldid_' + arr_field_id[0]).find('label#smiley_' + fid).html('<spna class="arf_smiley_icon"><i class="'+icon+'"></i></spna>');
        if(arfsmiley_type == 'image'){
            jQuery('#field-option-' + arr_field_id[0]).find('#arfsmiley_image_value_' + fid).html('<i class="'+icon+'"></i>');
            jQuery('#field-option-' + arr_field_id[0]).find('#arfsmiley_image_value_' + fid).attr('class','arfsmiley_icon_value');
            jQuery('#field-option-' + arr_field_id[0]).find('#arfsmiley_image_value_' + fid).attr('id','arfsmiley_icon_value_' + fid);
        }else{
            jQuery('#field-option-' + arr_field_id[0]).find('#arfsmiley_icon_value_' + fid).find('i').attr('class',icon);
        }
        jQuery('#field-option-' + arr_field_id[0]).find('#arfsmiley_type_' + fid).val('icon');
...
/*
jQuery(document).on('click', '#fa_size_medium', function () {   
});
jQuery(document).on('click', '#fa_size_large', function () {    
});
*/
...
function arf_conditional_redirect_add(){
    
    jQuery('.arf_conditional_redirect_bulk_add_remove').find('.bulk_add').attr('disabled', true);
    var metas = [];	
    jQuery('input[name^="rule_array_conditional_redirect"]').each(function(){ metas.push(this.value); }); 
    ...
    jQuery.ajax({
        type:"POST",
        url:ajaxurl,
        data:"action=arf_add_conditional_redirect_new_rule&next_rule_id="+next_meta_id,
        
        success:function(msg){			
			
        jQuery('#arf_rule_conditional_redirect_mian').append(msg);
        var dropdown = jQuery('#arf_conditional_redirect_filed_dropdown_html').html();
        
        jQuery('.arf_conditional_redirect_bulk_add_remove').find('.bulk_add').attr('disabled',false);
        jQuery('.arf_conditional_redirect_bulk_add_remove .bulk_remove').show();
        setTimeout(function(){
            jQuery('#arf_rule_conditional_redirect_mian').find(".arf_conditional_redirect_field_dropdown_ajax").html(dropdown);
        },100);
...
function arf_conditional_redirect_delete_rule(delete_id)
{
    if(delete_id != '') {
        if(jQuery('#arf_rule_conditional_redirect_mian .arf_conditional_redirect_logic_div').length > 2 ){
            jQuery('#arf_rule_conditional_redirect_mian').find("#arf_rule_conditional_redirect_"+delete_id).remove();
        }else{
            jQuery('#arf_rule_conditional_redirect_mian').find("#arf_rule_conditional_redirect_"+delete_id).remove();
            jQuery('.arf_conditional_redirect_bulk_add_remove .bulk_remove').hide();
        }
    }
...
// Added font awesome icon in icheck checkbox and radio button.
jQuery(document).on('click', '.arf_check_radio_container_wrapper', function (e) {
    var action = jQuery(this).attr('data-action');
    var type = jQuery(this).attr('data-field');
    var ftype = jQuery(this).attr('data-field_type');
    
    if (action == 'edit') {
        showfontawesomemodal(0,ftype);
    }
});

/*function showfontawesomemodalcheck(name) {
    jQuery('.arf_fainsideimge').attr('data-field', name);
}

jQuery(document).on('click', '.arf_fainsideimge_check', function (e) {
    var html = jQuery(this).html();
    var field = jQuery(this).attr('data-field');
    var ftype = jQuery('#arf_edit_prefix').attr('data-field_type');
    ...
    if (html == '') {
        ...
        add_editor_check_radio(field);
        jQuery('#arf_fontawesome_modal_check').arfmodal('hide');
        return false;
    }
...
function add_editor_check_radio(field) {
    
    if(field == 'checkbox'){
        var checked_checkbox_icons = '';
        var chk_checkbox_icon = jQuery('#arf_checkbox_icon').val();
        
        if(chk_checkbox_icon != ''){
            checked_checkbox_icons = ' arfa ' + chk_checkbox_icon;            
        } else {
            checked_checkbox_icons = '';
        }
        
        jQuery('#testiframe').contents().find('.arf_form input[type="checkbox"]').not('.arf_hide_opacity').iCheck({
                checkboxClass: 'icheckbox_custom',
                hoverClass: ' ',
                checkedCheckboxClass: checked_checkbox_icons
        });
//        jQuery('.icheckbox_custom').css('color', jQuery('#checked_checkbox_icon_color').val());
    }
    
    if(field == 'radio'){
        var checked_radio_icons = '';
        var chk_radio_icon = jQuery('#arf_radio_icon').val();
        
        if(chk_radio_icon != ''){
            checked_radio_icons = ' arfa ' + chk_radio_icon;
        } else {
            checked_radio_icons = '';
        }        
        
        jQuery('#testiframe').contents().find('.arf_form input[type="radio"]').not('.arf_hide_opacity').iCheck({
                radioClass: 'iradio_custom',
                hoverClass: ' ',
                checkedRadioClass: checked_radio_icons
        });        
//        jQuery('.iradio_custom').css('color', jQuery('#checked_radio_icon_color').val());
    }    
}

jQuery(document).on('change','input[name="opt_export"]',function(){
    
    var checked_val = jQuery(this).val();
    
    if( checked_val == 'opt_export_both' ){
	jQuery('#send_attachment_with_xml').show();
    } else {
	jQuery('#send_attachment_with_xml').hide();
    }
    
     
});

function arf_preset_field_show(id)
{
    jQuery(".arf_preset_field_content_wrapper_" + id).show();
}
function arf_update_preset_data(field_id) {
   
   var arf_preset_data =  jQuery('.arf_preset_data_'+field_id).val();
      
   var arf_preset_title =  jQuery('.arf_preset_title_'+field_id).val();
   
   var file_name = jQuery('.arf_preset_data_'+field_id).attr('db_file_name');
           
   var file_ext = arf_preset_data.lastIndexOf('.');
   
   var file_ext = arf_preset_data.substring(file_ext+1);
   
   var arf_preset_future_use = 0;
   ...
   else if(jQuery('#arf_preset_future_use_'+field_id).is(':checked') && arf_preset_title == "")
   {
       alert('Please enter preset title.');
       return false;
   }
   else if(file_name=="" || typeof file_name == 'undefined')
   {
       return false;
   }
   if(jQuery('#arf_preset_future_use_'+field_id).is(':checked'))
   {
        arf_preset_future_use = 1;
   }
   
    jQuery.ajax({
        type: "POST", url: ajaxurl,
        data: "action=arf_save_new_preset&file_name="+file_name+'&arf_preset_future_use='+arf_preset_future_use+'&arf_preset_title='+arf_preset_title,
        success: function (res) {
            jQuery('#arfshowfieldbulkoptions-'+field_id).find('.arf_selectbox dd ul').append(res);
            jQuery('#arfshowfieldbulkoptions-'+field_id+' .arf_selectbox dd ul').find('li').last().trigger('click');
            jQuery('#arfshowfieldbulkoptions-'+field_id).find('button.btn_apply').trigger('click');
        }
    });
}
jQuery(document).on('click','.arf_preset_future_use',function(){
    
    if(jQuery(this).is(':checked'))
    {
        jQuery(this).closest('.arf_preset_field_content_wrapper').find('.arf_preset_title').show();
    }
    else
    {
        jQuery(this).closest('.arf_preset_field_content_wrapper').find('.arf_preset_title').hide();
    }
});



function arf_change_range_selector_slider(field_id) {
    var type = jQuery('#slider_handle_' + field_id).val();
    
    if(jQuery('#arf_range_selector_' + field_id).is(':checked'))
    { 
        jQuery('#arf_slider_default_value_' + field_id).attr('disabled', 'disabled');
        jQuery('#arf_range_minnum_' + field_id).removeAttr('disabled');
        jQuery('#arf_range_maxnum_' + field_id).removeAttr('disabled');
        ...
        jQuery('#arf_slider_default_value_' + field_id).removeAttr('disabled');
        jQuery('#arf_range_minnum_' + field_id).attr('disabled', 'disabled');
        jQuery('#arf_range_maxnum_' + field_id).attr('disabled', 'disabled');
...
function arf_op_save_option(field_id,ref_field_id){
    var frm_data = jQuery("form#arf_op_form_"+field_id).serialize(); 
    var separate_value = false;
    if (jQuery('input#separate_value_' + field_id).is(':checked')) {
     separate_value =true;   
    }
    ...
    jQuery.ajax({
        type: "POST", url: ajaxurl,
        beforeSend: function() {
            jQuery('#arf_op_save_option_loder_'+field_id).fadeIn('slow');
        },
        data: "action=arf_save_field_option&form_data=" + frm_data + '&field_id=' + field_id+ '&ref_field_id=' + ref_field_id+'&separate_value=' + separate_value,
        success: function (res) {
            jQuery('#arf_op_save_option_loder_'+field_id).fadeOut('slow');
            
            
            arf_op_updateoptionorder(field_id,ref_field_id);
            arfreordercheckradio(field_id);
            arfcheckoptionlength(field_id);
            arf_update_name_dropdown();
...
function arf_op_updateoptionorder(field_id,ref_field_id)
{
    var order = jQuery('#arfoptionul_' + field_id).sortable('serialize');
    jQuery.ajax({type: "POST", url: ajaxurl, data: "action=arf_op_updateoptionorder&field_id=" + field_id + "&ref_field_id="+ref_field_id+"&" + order, success: function (res) {
            
    }});
}

function arfresetlicenseform() {
        jQuery('#arfresetlicenseform').css({display:''});
}

function Closeresetmodal()
{
	jQuery('#arfresetlicenseform').css({display:'none'});
	setTimeout(function () {
            jQuery('.arfmodal-backdrop').css({display:'none'});
        }, 50);
	
}

function arfmincurrentdatefieldfunction(field_id, current_date, chkflag) {

    var thisid = 'arf_show_min_current_date_field_' + field_id;
    
    if (current_date == '0')
    {
        var switch_to = '1';
        var checked = 'checked="checked"';
        jQuery('#arf_start_date_' + field_id).attr('disabled', 'disabled');        
    }
    else
    {
        var switch_to = '0';
        var checked = '';
        jQuery('#arf_start_date_' + field_id).removeAttr('disabled');
    }

    jQuery('#frm_' + thisid).attr('onchange', 'arfmincurrentdatefieldfunction(' + field_id + ',' + switch_to + ',2)');
    if (checked == '') {
        if (chkflag == '1')
        {
            switchery['frm_' + thisid].setPosition(true);
...
function arfmaxcurrentdatefieldfunction(field_id, current_date, chkflag) {

    var thisid = 'arf_show_max_current_date_field_' + field_id;

    if (current_date == '0')
    {
        var switch_to = '1';
        var checked = 'checked="checked"';
        jQuery('#arf_end_date_' + field_id).attr('disabled', 'disabled');
    }
    else
    {
        var switch_to = '0';
        var checked = '';
        jQuery('#arf_end_date_' + field_id).removeAttr('disabled');
    }

    jQuery('#frm_' + thisid).attr('onchange', 'arfmaxcurrentdatefieldfunction(' + field_id + ',' + switch_to + ',2)');
    if (checked == '') {
        if (chkflag == '1')
        {
            switchery['frm_' + thisid].setPosition(true);
