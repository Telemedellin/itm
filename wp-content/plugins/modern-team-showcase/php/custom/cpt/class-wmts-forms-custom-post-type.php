...
class WMTS_Forms_Custom_Post_Type {
	...
	public function __construct ( $post_type = '', $plural = '', $single = '', $description = '', $icon_url ) {
		...
		add_filter( 'get_user_option_screen_layout_modernteamforms', array( $this, 'set_screen_layout_columns' ) );
	...
	public function register_post_type () {
		...
		$labels = array(
			...
			'add_new' => __( 'Build New Form', 'modern-team-showcase' ),
			'add_new_item' => __( 'Build New Form' , 'modern-team-showcase' ),
			'edit_item' => sprintf( __( 'Edit %s' , 'modern-team-showcase' ), $this->single ),
			'new_item' => sprintf( __( 'New %s' , 'modern-team-showcase' ), $this->single ),
			'all_items' => __( 'All Forms' , 'modern-team-showcase' ),
